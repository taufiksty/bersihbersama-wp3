...
export default function Blogs({ totalBlogs, setSelectedMenuBlogs }) {
	return (
		<div className="max-w-sm md:w-[45%] lg:mt-0 mt-3 mb-5 md:mb-0 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
			<a
				href="#blog"
				onClick={setSelectedMenuBlogs}
