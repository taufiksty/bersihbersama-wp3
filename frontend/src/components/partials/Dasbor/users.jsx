...
export default function User(props) {
	return (
		<div className="max-w-sm md:w-[45%] p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
			<a href="#">
			...
			<p className="font-normal text-gray-700 dark:text-gray-400">
				Partisipan : {props.count_user}
			</p>
			<p className="font-normal text-gray-700 dark:text-gray-400">
				Admin : {props.count_admin}
			</p>
			<p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
				Total Pengguna : {props.total_users}
			</p>
			<a
        href="#"
        onClick={props.setSelectedMenuUsers}
