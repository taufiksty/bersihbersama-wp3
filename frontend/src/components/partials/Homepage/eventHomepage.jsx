					...
					<div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
						...
						<div className="p-5">
							...
							<button
								...
								className="text-white text-xs mb-3 bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-3 py-1 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
								Ikuti
								<svg
									aria-hidden="true"
							...
							<p className="font-light text-blue-500 dark:text-blue-400 cursor-pointer hover:underline">
								<a href="">Lihat peta</a>
							</p>
						</div>
					</div>
