...
export default function ModalUpdateBlog(props) {
	const [imageFile, setImageFile] = React.useState(null);
	const [valueSubmit, setValueSubmit] = React.useState(props.blog);
	...
	const handleUpdateSubmit = (e) => {
		...
		axios
			.post(`http://localhost:8080/api/v1/blogs/update/${props.blog.id}`, formData, {
				headers: {
