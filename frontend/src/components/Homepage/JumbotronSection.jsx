		...
		<section
			...
			<div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
				...
				<div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
					<a
						href={token === undefined ? '/login' : '/events'}
						className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 cursor-pointer">
						Mulai aksi
						<svg
							aria-hidden="true"
					...
					<a
						href={token === undefined ? '/login' : '/blogs'}
