...
export default function Navbar(props) {
	...
	const { image, name, email, role } = props.credentials.user;
							...
							<a
								...
								className={`block py-2 pl-3 pr-4 ${
									activeSection === 'home'
										...
										: 'text-gray-900'
								} text-gray-900 rounded hover:bg-primary-600 hover:text-white md:hover:bg-transparent md:hover:text-primary-700 md:p-0 md:dark:hover:text-primary-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700`}
								aria-current="page">
								Home
							</a>
						</li>
								...
								<div>
									<button
										...
										<img
											...
											src={`http://localhost:8080/images/profile/${image}`}
											alt="user photo"
										/>
									</button>
								</div>
